...
-- =============================================
CREATE TABLE IF NOT EXISTS available_equipments (
...
INSERT INTO recipes (recipe_name, ingredients, calories, protein, carbs, fats, prep_time_minutes, servings, instructions) VALUES
('Protein Smoothie', 'Banana, Protein Powder, Milk, Berries', 350.0, 25.0, 30.0, 8.0, 5, 1, 'Blend all ingredients until smooth'),
('Grilled Chicken Breast', 'Chicken Breast, Olive Oil, Herbs', 250.0, 35.0, 0.0, 12.0, 20, 1, 'Season and grill chicken until cooked'),
('Quinoa Bowl', 'Quinoa, Vegetables, Chickpeas, Tahini', 400.0, 15.0, 45.0, 12.0, 25, 1, 'Cook quinoa, mix with vegetables and dressing'),
('Greek Yogurt Parfait', 'Greek Yogurt, Granola, Honey, Berries', 280.0, 20.0, 35.0, 6.0, 10, 1, 'Layer yogurt, granola, and berries'),
('Salmon with Sweet Potato', 'Salmon, Sweet Potato, Broccoli, Lemon', 450.0, 30.0, 35.0, 18.0, 30, 1, 'Bake salmon and sweet potato, steam broccoli')
...
ALTER TABLE available_equipments ENABLE ROW LEVEL SECURITY;
ALTER TABLE exercises ENABLE ROW LEVEL SECURITY;
ALTER TABLE training_records ENABLE ROW LEVEL SECURITY;
ALTER TABLE recipes ENABLE ROW LEVEL SECURITY;
ALTER TABLE diet_recommendation ENABLE ROW LEVEL SECURITY;

-- Create policies for public access
CREATE POLICY "Enable read access for all users" ON user_profile FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all users" ON user_profile FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all users" ON user_profile FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all users" ON user_profile FOR DELETE USING (true);

CREATE POLICY "Enable read access for all users" ON available_equipments FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all users" ON available_equipments FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all users" ON available_equipments FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all users" ON available_equipments FOR DELETE USING (true);
...
CREATE POLICY "Enable read access for all users" ON training_records FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all users" ON training_records FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all users" ON training_records FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all users" ON training_records FOR DELETE USING (true);
...
CREATE POLICY "Enable read access for all users" ON diet_recommendation FOR SELECT USING (true);
CREATE POLICY "Enable insert access for all users" ON diet_recommendation FOR INSERT WITH CHECK (true);
CREATE POLICY "Enable update access for all users" ON diet_recommendation FOR UPDATE USING (true);
CREATE POLICY "Enable delete access for all users" ON diet_recommendation FOR DELETE USING (true);
